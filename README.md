...
집사 메뉴 → ✨ 퀘스트 만들기 → 🌐 커뮤니티 탭에서 불러오거나, 아래 JSON을 📋 JSON 가져오기에 붙여넣으세요.

| 퀘스트 | 난이도 | 단계 | 설명 |
|--------|--------|------|------|
| [🪝 Hooks 마스터리](https://github.com/ernestolee13/quest-coder/releases/download/v0.0.1/quest-hooks-mastery.json) | 중급 | 5 | PreToolUse/PostToolUse/UserPromptSubmit 훅으로 자동화 파이프라인 구축 |
| [🏗️ gstack 엔지니어링 팀](https://github.com/ernestolee13/quest-coder/releases/download/v0.0.1/quest-gstack.json) | 중급 | 5 | Garry Tan의 28개 스킬로 Claude를 가상 엔지니어링 팀으로 활용 |
| [🔬 Autoresearch 자기 개선](https://github.com/ernestolee13/quest-coder/releases/download/v0.0.1/quest-autoresearch.json) | 고급 | 5 | Karpathy의 autoresearch 패턴으로 SKILL.md 자동 개선 루프 |
| [📋 CLAUDE.md 파워유저](https://github.com/ernestolee13/quest-coder/releases/download/v0.0.1/quest-claudemd-power.json) | 입문 | 5 | 프로젝트 맞춤 CLAUDE.md로 Claude 성능 극대화 |
| [⚛️ React 기초 실습](https://github.com/ernestolee13/quest-coder/releases/download/v0.0.1/example-quest-react.json) | 입문 | 6 | Claude Code로 React Todo 앱 만들기 |

나만의 퀘스트를 만들어서 공유할 수도 있어요! 자세한 내용은 [퀘스트 만들기 가이드](#-퀘스트-생성-ai--커뮤니티)를 참고하세요.
